...
- **Developers:** [architecture](docs/architecture.md) · [utility jobs](docs/utility-job-orchestration.md) · [bridges](docs/webview-bridges.md) · [data models](docs/data-model-reference.md) · [services](docs/services-reference.md) · [testing](docs/testing.md) · [Linear integration](docs/linear-integration.md) · [agents](AGENTS.md)
...
**Docs:** [Adventure Panel Reference](docs/adventure-panel.md) · [Projects & sync](docs/user-projects-and-sync.md) · [Adventures roadmap](docs/INDEX.md#adventures-roadmap-phase-status)

**Quick smoke tests:** Play loop and Projects API checklists are in [docs/user-projects-and-sync.md](docs/user-projects-and-sync.md) and [docs/adventure-panel.md](docs/adventure-panel.md#manual-play-mode-smoke-checklist).
