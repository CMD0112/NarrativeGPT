...
internal static class ThemeResourceUpdater
{
    ...
    private static void ApplyToDictionary(ResolvedTheme theme, ResourceDictionary resources)
    {
        ...
        resources["SegmentButtonPadding"] = compact ? new Thickness(10, 4, 10, 4) : new Thickness(14, 6, 14, 6);
        resources["CommandBarSecondaryPadding"] = compact ? new Thickness(10, 4, 10, 4) : new Thickness(12, 6, 12, 6);
        resources["StatusChipPadding"] = compact ? new Thickness(6, 3, 6, 3) : new Thickness(8, 4, 8, 4);
        resources["ActionListRowPadding"] = compact ? new Thickness(8, 6, 8, 6) : new Thickness(10, 8, 10, 8);
        resources["ActionListRowMargin"] = compact ? new Thickness(0, 0, 0, 4) : new Thickness(0, 0, 0, 6);
        resources["ShellIconLabelVisibility"] = compact ? Visibility.Collapsed : Visibility.Visible;
        resources["ShellIconLabelGap"] = compact ? new Thickness(0) : new Thickness(0, 0, 6, 0);
