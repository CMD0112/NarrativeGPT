...
internal static class DiagnosticsSession
{
    public static void WriteExtendedHeader(string[]? startupArgs = null)
    {
        ...
        var version = DiagnosticsHostContext.GetAppVersion?.Invoke() ?? "unknown";
        var logsRoot = DiagnosticsPaths.ConfigRoot;
        var legacy = DiagnosticsHostContext.LegacyLogs;
        ...
        DiagnosticsLog.Write(
            ...
            data: new
            {
                ...
                logs = new
                {
                    ...
                    linkProject = legacy?.LinkProject,
                    syncTrace = legacy?.SyncTrace,
                    discoveryTrace = legacy?.DiscoveryTrace,
                    folder = logsRoot,
                },
                agentHint =
