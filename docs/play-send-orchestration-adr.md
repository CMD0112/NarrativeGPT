...
**Companion plan:** [play-send-orchestration-implementation-plan.md](play-send-orchestration-implementation-plan.md)
...
**Related:** [architecture.md](architecture.md) · [webview-bridges.md](webview-bridges.md) · [chatgpt-api-integration.md](chatgpt-api-integration.md) · [injection-policy-adr.md](injection-policy-adr.md) · [play-thread-canonical-adr.md](play-thread-canonical-adr.md)
