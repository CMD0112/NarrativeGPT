...
**Read order:** [instruction-sources-paradigm.md](instruction-sources-paradigm.md) (theory) → **this doc** (glossary + routing) → [instruction-contract-guide.md](instruction-contract-guide.md) (authoring) → [injection-policy-adr.md](injection-policy-adr.md) (assembly rules) → [narrator-settings.md](narrator-settings.md) (runtime overrides)
