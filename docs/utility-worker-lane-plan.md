...
**Companion ADR:** [utility-worker-lane-adr.md](utility-worker-lane-adr.md)

**Builds on:** [play-thread-utility-orchestration-plan.md](play-thread-utility-orchestration-plan.md) · [utility-delivery-pivot-adr.md](utility-delivery-pivot-adr.md)
