...
See [Testing](testing.md) for local commands and live/perf tiers.
...
Several guides already cross-reference CMD issues (e.g. [adventure-panel.md](adventure-panel.md), [prompt-construction-guide.md](prompt-construction-guide.md)).
