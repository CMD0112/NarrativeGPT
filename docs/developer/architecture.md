...
| `MainWindow.ThreadConversationLog.cs` | Per-thread rolling log sync and manual dump |
...
See [Data Model Reference](../reference/data-model-reference.md).
...
Shell theming (WPF chrome + WebView `--cgw-*` variables) is separate from **Format…** transcript typography. See [appearance-theme-settings.md](../settings/appearance-theme-settings.md) and [user-guide.md](../user/user-guide.md).
...
- [Services Reference](../reference/services-reference.md) — business logic catalog
- [UI Components](../reference/ui-components.md) — WPF inventory
