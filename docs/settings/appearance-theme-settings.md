...
**Related:** [User Guide — Appearance & theme](../user/user-guide.md#appearance--theme) · [UI Components — Themes](../reference/ui-components.md#themes-themes) · [CMD-111](https://linear.app/cmd0112/issue/CMD-111) epic · [CMD-179](https://linear.app/cmd0112/issue/CMD-179) wave 2 phase 1
...
Transcript typography and role colors remain in **Format…** (see [Continuous transcript view](../user/user-guide.md#continuous-transcript-view)).
...
- [Injected Assets](../developer/injected-assets.md) — JS/CSS injection details
- [Narrator Settings](../user/narrator-settings.md) — play-side panel (not appearance)
- [linear-issue-reference.md](../linear/linear-issue-reference.md) — issue taxonomy
