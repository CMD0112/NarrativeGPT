...
**Related:** [Inventory](settings-interactables-inventory.md) · [Audit findings](settings-interactables-audit.md) · [Appearance & theme](appearance-theme-settings.md) · [UI Components](../reference/ui-components.md) · [WPF scroll & overflow layout](../reference/ui-components.md#wpf-scroll--overflow-layout-contract-cmd-278--cmd-285)
...
When adding settings UI or changing discovery paths, update this ADR, [settings-interactables-inventory.md](settings-interactables-inventory.md), and [ui-components.md](../reference/ui-components.md) in the same change.
