...
**Related:** [Settings UX taxonomy](settings-ux-taxonomy.md) · [Audit findings](settings-interactables-audit.md) · [UI Components](ui-components.md) · [Appearance & theme](appearance-theme-settings.md)
...
Update this inventory when adding settings UI, new dialogs, or deprecating controls. Cross-check against [ui-components.md](ui-components.md) and [data-model-reference.md](data-model-reference.md).
