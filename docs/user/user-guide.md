...
See **[Appearance & Theme Settings](../settings/appearance-theme-settings.md)** for the full scope model, token catalog, CSS layering, and expansion roadmap.
...
- [Injected Assets](../developer/injected-assets.md) — technical details of JS/CSS files
