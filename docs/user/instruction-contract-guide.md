...
Related docs: [instruction-sources-paradigm.md](instruction-sources-paradigm.md) · [adventure-panel.md](adventure-panel.md) · [user-projects-and-sync.md](user-projects-and-sync.md) · [data-model-reference.md](../reference/data-model-reference.md)
...
- [Data Model — AdventureSettings](../reference/data-model-reference.md#adventuresettings) — JSON field reference
