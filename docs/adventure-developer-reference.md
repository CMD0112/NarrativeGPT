...
Developer-oriented companion to [Adventure Panel Reference](adventure-panel.md): data model, persistence, turn automation, packet construction internals, project linking, source sync, and key services.

**Documentation hub:** [INDEX.md](INDEX.md)

**Related:** [Data Model Reference](data-model-reference.md) · [Services Reference](services-reference.md) · [Prompt Construction Guide](prompt-construction-guide.md) · [user-projects-and-sync.md](user-projects-and-sync.md) · [instruction-sources-paradigm.md](instruction-sources-paradigm.md) · [WebView Bridges](webview-bridges.md) · [utility-job-orchestration.md](utility-job-orchestration.md)
...
**Full catalog:** [Services Reference](services-reference.md)