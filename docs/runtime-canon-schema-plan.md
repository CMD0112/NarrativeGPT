...
2. **Hybrid storage retained** — identity columns + typed hot fields + `extendedFields` bag (ADR in [canon-schema.md](canon-schema.md)).
...
- Document in [data-model-reference.md](data-model-reference.md).
...
- [canon-schema.md](canon-schema.md) — CMD-191 ADR (hybrid model)  
- [data-model-audit-cmd86.md](data-model-audit-cmd86.md) — drift findings  
