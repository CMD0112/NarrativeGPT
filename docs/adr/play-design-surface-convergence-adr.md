...
See also [adventure-thread-registry.md](../reference/adventure-thread-registry.md) — Play and Design remain distinct thread kinds in the registry regardless of UI merge outcome.
...
- [architecture.md](../developer/architecture.md) — Application modes
- [adventure-panel.md](../user/adventure-panel.md) — Play/Design user flows
- [adventure-thread-registry.md](../reference/adventure-thread-registry.md) — thread kind model
- [services-reference.md](../reference/services-reference.md) — design suite and generation jobs
