...
**Implementation plan:** [injection-policy-implementation-plan.md](../plans/injection-policy-implementation-plan.md)

Normative supplement to [instruction-sources-paradigm.md](../user/instruction-sources-paradigm.md). When this ADR and the paradigm disagree during CMD-292 rollout, **this ADR wins** for assembly order, deduplication, and preview honesty.
...
**Known gap (CMD-43):** Addressed in v1 by [CMD-396](https://linear.app/cmd0112/issue/CMD-396) (`UtilityStoryContextDedup` + consolidated continuity handler). Audit CMD-294 follow-up if legacy flag-off path still duplicates.
...
| Instruction channel UI glossary | [instruction-channels.md](../user/instruction-channels.md) (CMD-289) |
...
- [instruction-sources-paradigm.md](../user/instruction-sources-paradigm.md) — four channels theory
- [prompt-construction-guide.md](../user/prompt-construction-guide.md) — builder entry points
- [narrator-settings.md](../user/narrator-settings.md) — runtime overrides
