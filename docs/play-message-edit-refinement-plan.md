...
**Normative baseline:** [play-thread-canonical-adr.md](play-thread-canonical-adr.md) (symmetric tail invalidation, thread-canonical play).
...
**Related:** [CMD-46](https://linear.app/cmd0112/issue/CMD-46) (invalidation semantics) · [CMD-331](https://linear.app/cmd0112/issue/CMD-331) (utility message hiding — pattern reference) · [adventure-panel.md](adventure-panel.md) · [services-reference.md](services-reference.md)
...
**Deliverable:** `docs/user-message-edit-adr.md` (or section in `play-thread-canonical-adr.md`).
...
**Deliverable:** `docs/narrator-revision-adr.md`.
...
| `docs/play-thread-canonical-adr.md` | ● | ● |
| `docs/user-message-edit-adr.md` | ● (new) | |
| `docs/narrator-revision-adr.md` | | ● (new) |
...
| Doc | When |
|-----|------|
| `docs/user-message-edit-adr.md` | CMD-350 |
| `docs/narrator-revision-adr.md` | CMD-352 |
| `docs/play-thread-canonical-adr.md` | Update edit transport table after ADRs |
| `docs/adventure-panel.md` | CMD-188 / epic sign-off — user + narrator edit workflows |
| `docs/user-guide.md` | CMD-356 — format settings |
