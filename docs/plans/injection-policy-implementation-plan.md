...
**Companion ADR:** [injection-policy-adr.md](../adr/injection-policy-adr.md) — normative policy (CMD-293, shipped).

**Related canon:** [instruction-sources-paradigm.md](../user/instruction-sources-paradigm.md) · [prompt-construction-guide.md](../user/prompt-construction-guide.md) · [narrator-settings.md](../user/narrator-settings.md) · [Enhancements/attachment-aware-context-injection.md](../Enhancements/attachment-aware-context-injection.md)
...
### CMD-293: ADR (`docs/adr/injection-policy-adr.md`)
...
| `docs/user/adventure-panel.md` | Author workflow |
| `docs/user/narrator-settings.md` | Cross-link injection cockpit |
...
Sign-off recorded in [prompt-construction-guide.md — CMD-56 sign-off](../user/prompt-construction-guide.md#cmd-56-sign-off-2026-06-22).
