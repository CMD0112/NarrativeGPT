...
**Companion ADR (normative):** [play-send-orchestration-adr.md](../adr/play-send-orchestration-adr.md)

**Motivation:** Draft-only sends, preview/send drift, passthrough policy bugs, DOM fill truncation, and schema-6 pin drift. See [troubleshooting.md](../user/troubleshooting.md) (`play-send-trace.jsonl`).

**Related:** [architecture.md](../developer/architecture.md) · [webview-bridges.md](../developer/webview-bridges.md) · [chatgpt-api-integration.md](../developer/chatgpt-api-integration.md) · [injection-policy-adr.md](../adr/injection-policy-adr.md) · [play-thread-canonical-adr.md](../adr/play-thread-canonical-adr.md) · [services-reference.md](../reference/services-reference.md)
...
- [x] [play-send-orchestration-adr.md](../adr/play-send-orchestration-adr.md) (this repo)  
...
| Doc | Update |
|-----|--------|
| [architecture.md](../developer/architecture.md) | Play send section → orchestrator diagram |
| [webview-bridges.md](../developer/webview-bridges.md) | DOM delivery = fallback; wrapper composer mandatory |
| [chatgpt-api-integration.md](../developer/chatgpt-api-integration.md) | Play send default path |
| [adventure-panel.md](../user/adventure-panel.md) | Begin-play checklist: wrapper composer, armed state |
| [troubleshooting.md](../user/troubleshooting.md) | New trace events; disarm reason table |
| [services-reference.md](../reference/services-reference.md) | New PlaySend services |
| [testing.md](../developer/testing.md) | New test files + manual QA gate |
...
Create epic **Play Send Orchestration** with child issues mirroring Phases 0–9. Link PRs `Ref CMD-XX`. Mark **Done** only after manual QA checklist + **Verified** label per [linear-issue-reference.md](../linear/linear-issue-reference.md).
