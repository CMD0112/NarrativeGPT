...
**Companion ADR (normative):** [play-thread-utility-orchestration-adr.md](../adr/play-thread-utility-orchestration-adr.md) — deliverable for [CMD-327](https://linear.app/cmd0112/issue/CMD-327).

**Builds on:** [utility-delivery-pivot-adr.md](../adr/utility-delivery-pivot-adr.md) (CMD-248 — dedicated-thread retirement) · [injection-policy-adr.md](../adr/injection-policy-adr.md) (CMD-293) · [utility-job-orchestration.md](../developer/utility-job-orchestration.md) (current pipeline).

**Related:** [prompt-construction-guide.md](../user/prompt-construction-guide.md) · [services-reference.md](../reference/services-reference.md) · [adventure-panel.md § Generation jobs](../user/adventure-panel.md#generation-jobs-phase-2)
...
**Design-thread jobs** (`propose_json_import`, `design_extract_step`, etc.) stay on the design WebView per [utility-delivery-pivot-adr.md](../adr/utility-delivery-pivot-adr.md). This plan scopes **play-thread** jobs only.
...
`docs/adr/play-thread-utility-orchestration-adr.md` — normative decisions this plan implements.
...
| `docs/user/prompt-construction-guide.md` | Utility schema section |
...
- [ ] `docs/developer/utility-job-orchestration.md` rewritten for injection-first model
